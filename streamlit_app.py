...
def main():
    ...
    logo = Image.open("/Users/indiradas/Desktop/RAG project/ai_logo.png")  # Replace with your logo path

    # Adjust the size: Increase width and reduce height
    new_width = 60  # Set your desired width
    new_height = 20  # Set your desired height
